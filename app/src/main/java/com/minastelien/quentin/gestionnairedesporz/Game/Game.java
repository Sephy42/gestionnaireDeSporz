...
public class Game {
    ...
    public static class GameSingleton {
         ...
         * Role attributes
         */
        public final Role MUTANT_DE_BASE = new Role("Mutant de base", "Chaque nuit les mutants vont désigner un joueur à muter. Ce joueur est transformé en mutant.\nIls désignent aussi une personne à paralyser ou infecter. Une personne paralysée n'aura pas la possibilité de jouer son action cette nuit, mais agira normalement par la suite. Une personne infectée ne peut ni être espionnée, ni être inspectée par le psychologue ou le généticien.", Role.Side.MUTANT, true, R.layout.fragment_role_mutant_de_base, R.string.texte_mutant);
        ...
        public final Role PSYCHOLOGUE = new Role("Psychologue", "Chaque nuit le Psychologue désigne un joueur. Il apprend son état (si sa cible est mutante ou non (mais ne connait pas son rôle)). Cet état est inaccessible si la cible est infectée.", Role.Side.HUMAIN, false, R.layout.fragment_role_default, R.string.texte_psychologue);
        public final Role GENETICIEN = new Role("Généticien", "Chaque nuit le Généticien désigne un joueur. Il apprend son génôme (si sa cible est de génôme Résistant, Hôte, ou Standard). Ce génôme est inaccessible si la cible est infectée.\nLe Résistant ne peut jamais être muté.\nLes Hôtes ne peuvent jamais êtes soignés.\nLes joueurs de génômes Standard peuvent être mutés ou soigner normalement.", Role.Side.HUMAIN, false, R.layout.fragment_role_default, R.string.texte_geneticien);
